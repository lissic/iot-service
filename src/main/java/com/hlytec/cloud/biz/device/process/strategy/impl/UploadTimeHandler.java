 ...
 */
@Slf4j
@Component("/ToSer/RYX/9_SetBatteryTimerParam")
public class UploadTimeHandler implements ProcessMqttMsgStrategy {
    @Autowired
    ...
    public void processMqttMsg(String message) {
        log.info("upload message from time,{}", message);
        // 推送结果至前端
        ...
        DeviceLog deviceLog = logService.findOneWithResultNull(DeviceLog.builder().cardId(cardId).operationType(9)
