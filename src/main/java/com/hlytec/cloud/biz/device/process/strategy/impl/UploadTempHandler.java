 ...
 */
@Slf4j
@Component("/ToSer/RYX/7_SetBatteryTemperatureParam")
public class UploadTempHandler implements ProcessMqttMsgStrategy {
    @Autowired
    ...
    public void processMqttMsg(String message) {
        log.info("upload message from temp,{}", message);
        // 推送结果至前端
        ...
        DeviceLog deviceLog = logService.findOneWithResultNull(DeviceLog.builder().cardId(cardId).operationType(7)
