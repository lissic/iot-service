 ...
 */
@Slf4j
@Component("/ToSer/RYX/6_SetBatteryFieldParam")
public class UploadParamHandler implements ProcessMqttMsgStrategy {
    @Autowired
    ...
    public void processMqttMsg(String message) {
        log.info("upload message from param,{}", message);
        // 推送结果至前端
        ...
        DeviceLog deviceLog = logService.findOneWithResultNull(DeviceLog.builder().cardId(cardId).operationType(6)
