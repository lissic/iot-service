 ...
 */
@Slf4j
@Component("/ToSer/RYX/8_SetBatteryChargingParam")
public class UploadChargeHandler implements ProcessMqttMsgStrategy {
    @Autowired
    ...
    public void processMqttMsg(String message) {
        log.info("upload message from charge,{}", message);
        // 推送结果至前端
        ...
        DeviceLog deviceLog = logService.findOneWithResultNull(DeviceLog.builder().cardId(cardId).operationType(8)
